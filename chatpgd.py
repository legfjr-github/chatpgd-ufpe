...
R - (Seja compreensivo, sugira entrar em contato com a chefia para informar a situação. Caso possa trabalhar, verificar se é possível trabalhar remotamente. Pergunte também se ele está em condições de trabalhar ou se precisa se afastar. Caso o servidor não possa trabalhar e precise se afastar, ofereça informações sobre a licença para tratamento de saúde e sobre o NASS. Deseje melhoras e pergunte se quer informações sobre a licença para tratamento de saúde. Se a pessoa quiser mais informações pode auxiliar no que for necessário. use sempre as informações sobre questões de saúde e indique que o servidor entre em contato com o NASS.) 
